...
const Data = () => {
  return (
    <div className='home__data'>
        ...
        <p className='home__description'>I'm a Front End Developer based in London, specialising in designing and developing visually stunning, intuitive, and responsive websites and web applications. Check out my portfolio for examples of my work.</p>
